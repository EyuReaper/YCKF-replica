...
import CurrencyDisplay from '@/components/CurrencyDisplay'; // New import
      ...
      <main className="flex-1">
        ...
        <section className="px-4 py-16 mx-auto max-w-7xl">
          <div className="text-center">
            <h1 className="mb-6 text-4xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100">
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <Link 
                ...
                className="inline-block px-6 py-3 text-lg font-semibold text-white transition-colors duration-200 bg-blue-600 rounded-lg shadow-md hover:bg-blue-700"
              >
                Student Dashboard
              </Link>
              <Link 
                href="/free-training" 
                className="inline-block px-6 py-3 text-lg font-semibold text-gray-800 transition-colors duration-200 bg-gray-200 rounded-lg shadow-md hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600"
              >
                Free Training
              </Link>
            </div>
        ...
        <section className="px-4 pb-16 mx-auto max-w-7xl">
          {courses.length > 0 ? (
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {courses.map((course) => (
                <div key={course._id} className="overflow-hidden transition-shadow duration-200 bg-white border border-gray-100 shadow-lg rounded-xl dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl">
                  {course.image?.asset && (
                    <img
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-col space-y-2">
                      <Link
                        ...
                        className="inline-block px-4 py-2 text-sm font-medium text-center text-white transition-colors duration-200 bg-blue-600 rounded-md hover:bg-blue-700"
                      >
                        View Details
                      </Link>
                      <Link
                        href={`/premium-training/${course.slug.current}/enroll`}
                        className="inline-block px-4 py-2 text-sm font-medium text-center text-blue-600 transition-colors duration-200 rounded-md bg-blue-50 hover:bg-blue-100 dark:bg-blue-900 dark:text-blue-200 dark:hover:bg-blue-800"
                      >
                        Enroll Now
                      </Link>
                    </div>
        ...
        <section className="px-4 py-16 mx-auto rounded-lg max-w-7xl bg-gray-50 dark:bg-gray-800">
          <div className="text-center">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-700">
                <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 text-blue-600 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-200">
              ...
              <div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-700">
                <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 text-green-600 bg-green-100 rounded-full dark:bg-green-900 dark:text-green-200">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-700">
                <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 text-purple-600 bg-purple-100 rounded-full dark:bg-purple-900 dark:text-purple-200">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
